...
export default function MyItemsScreen({ navigation }) {
    ...
    const renderItem = ({ item }) => {
        ...
        return (
            ...
            >
                {primaryUri ? (
                    <Image source={{ uri: primaryUri }} style={styles.itemImage} />
                ) : (
            ...
            <View style={styles.header}>
                ...
                <View style={styles.statsContainer}>
                    <View style={[styles.statBox, styles.statBoxAccent]}>
                        <Text style={[styles.statNumber, styles.statNumberAccent]}>{stats.total}</Text>
                        <Text style={[styles.statLabel, styles.statLabelAccent]}>Total Items</Text>
                    </View>
